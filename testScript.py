...
input_json_path = os.path.join(downloads_path, "test_parcels_145.json")
output_json_path = os.path.join(downloads_path, "test_model_analysis_145_23-24.json")
...
def run_live_batch_test():
    ...
    for index, parcel in enumerate(parcels):
        ...
        payload = {
            "task_id": task_id,
            "kml_coordinates": kml,
            "end_date": "2024-06-25" # Consistent date for accuracy benchmarking
        }
