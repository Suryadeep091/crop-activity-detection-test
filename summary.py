...
results_file = os.path.join(downloads_path, "batch_results_dual_pipeline_300_1.json")
comparison_report = os.path.join(downloads_path, "accuracy_comparison_300_new_1.txt")
