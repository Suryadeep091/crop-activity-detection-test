...
results_file = os.path.join(downloads_path, "batch_results_dual_pipeline.json")
comparison_report = os.path.join(downloads_path, "accuracy_comparison_dual_pipeline.txt")
