...
results_file = os.path.join(downloads_path, "batch_results_300_Whittaker_latest.json")
comparison_report = os.path.join(downloads_path, "accuracy_comparison_300_Whittaker_latest.txt")
